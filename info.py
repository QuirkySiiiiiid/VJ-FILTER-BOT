...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '2090517919').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002121937308'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002249464432 -1002125588996 -1002008657265 -1002008657265').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001712434868') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request File With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002220770820')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None

# This Is Your Bot Support Group Id , Here Bot Will Not Give File Because This Is Support Group.
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002432527808')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002008657265')).split()]  # For Multiple Id Use One Space Between Each.
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Violet')
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://graph.org/file/.jpg') # payment code picture url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+QjFmXmHXGyMwZmE1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Moviess_Ok')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '+QjFmXmHXGyMwZmE1') # Support Chat Link Without https:// or @
